...
# 0001-0004) and add Nikon liveview emulation so capture_preview()
# streams frames from the seeded liveview animation (patch 0005, frames
# generated by seed_liveview below) — see the in-code comments in each
# patch for the full rationale.
...
# The vusb liveview emulation (vendor/patches/0005) streams the sorted
